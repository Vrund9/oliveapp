...
const Footer = () => {
  return (
    <>
      <footer className="container px-5 py-24 sm:py-6 mx-auto flex md:items-center md:py-12 md:px-8 lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
